    ...
    >
      <View style={{flexDirection : "column"}}>
        <View style={styles.container}>
          <DayViewScreen selected={selected === 0} position={selected === 0 ? 1 : selected === 1 ? 0 : 2}>
            <Text style={styles.screenText}  onPress={() => openList("Cultural")}>Day 1</Text>
          </DayViewScreen>
          <DayViewScreen selected={selected === 1} position={selected === 0 ? 2 : selected === 1 ? 1 : 0}>
            <Text style={styles.screenText}  onPress={() => openList("Technical")}>Day 2</Text>
          </DayViewScreen>
          <DayViewScreen selected={selected === 2} position={selected === 0 ? 0 : selected === 1 ? 2 : 1}>
            <Text style={styles.screenText} onPress={() => openList("Sports")}>Day 3</Text>
          </DayViewScreen>
        </View>
